...
public class myBankATM extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        amoundField = new javax.swing.JTextField();
        ...
        withdrawButton.setText("Make a withdrobel");
        ...
        statusField.setText("Welcome to my Bank!!!  Enter client ID and press ENTER");
    ...
    private void enterButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterButtonActionPerformed
        int customerID = 0;
        try{
            customerID = Integer.parseInt(amoundField.getText());
            ...
            historyArea.append("Eror: Customer with ID = " + customerID + " not found \n");
        }
        amoundField.setText("");
    ...
    private void balanceButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_balanceButtonActionPerformed
        ...
        if(currentAccount instanceof CheckingAccount){
            ...
            historyArea.append(". This is saving account with interest rate" + (((SavingsAccount)currentAccount).getInterestRate()) + "\n");
    ...
    private void depositButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_depositButtonActionPerformed
        try{
            double atm = Double.parseDouble(amoundField.getText());
            currentAccount.deposit(atm);
            historyArea.append("Deposit: $" + atm + ", new balance is $ " + currentAccount.getBalance() + "\n");
            amoundField.setText("");
        }catch(Exception ex){
    ...
    private void withdrawButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_withdrawButtonActionPerformed
        try{
            double atm = Double.parseDouble(amoundField.getText());
            if(currentAccount.withdraw(atm)){
                historyArea.append("Deposit: $" + atm + ", new balance is $ " + currentAccount.getBalance() + "\n");
                }
    ...
    private void addDigit(ActionEvent evt) {
        amoundField.setText(amoundField.getText() + ((JButton)evt.getSource()).getText());
    }
    ...
    private javax.swing.JTextField amoundField;
